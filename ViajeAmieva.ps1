...
<div class="wrap">
  ...
  <section id="t-inicio" class="tab active">
    ...
    <details class="card fold">
      ...
      <p class="hint" style="margin-top:8px">1. Abre este archivo (index.html) en el movil (te lo envias por WhatsApp/Telegram o lo abres desde Drive).<br>2. En el menu de Chrome (3 puntos) pulsa <b>Anadir a pantalla de inicio</b>: queda como una app.<br>3. Pasaselo igual a tu copiloto para que siga el plan.<br>Funciona sin internet (salvo abrir Maps). Para precios y tiempo al dia, vuelve a generar el panel en el PC y reenvialo.</p>
    </details>
  </section>
  ...
  <footer>Para refrescar precios, abre de nuevo "Abrir panel.bat". Lo que apuntes se guarda en este movil/navegador.</footer>
</div>
